...
def test_get_book_and_student_by_qr_id(client):
...
def test_qr_decode_resolves_student_by_qr_id(client):
    ...
    qr_image = _make_qr_image(student["qr_id"])
